...
namespace Azure
{
    public class DestinationService
    {
        ...
        public DestinationService(String PortalId, String UserName, String Password, String Domain, String OrganizationUrl, String DiscoveryUrl, String Source, String Type, String OrganizationName, String Region,
            String UseSSL, String IsOffice365, String ConfigurationId, String UseCache)
        {
            ...
            if (Type.Equals("3"))
            {
                _connectionClient = new CrmServiceClient(new System.Net.NetworkCredential(UserName, Password, Domain), AuthenticationType.IFD, OrganizationUrl, useSSL ? "443" : null, OrganizationName, useSsl: useSSL, useUniqueInstance: false);
            ...
            {
                _connectionClient = new CrmServiceClient(new System.Net.NetworkCredential(UserName, Password, Domain), AuthenticationType.AD, OrganizationUrl, useSSL ? "443" : null, OrganizationName, useSsl: useSSL, useUniqueInstance: false);
                _service = (IOrganizationService)_connectionClient.OrganizationServiceProxy;
            ...
            {
                _connectionClient = new CrmServiceClient(UserName, CrmServiceClient.MakeSecureString(Password), region, OrganizationName, useUniqueInstance: true, useSsl: useSSL, isOffice365: isoffice365);
                _service = (IOrganizationService)_connectionClient.OrganizationServiceProxy;
            }
